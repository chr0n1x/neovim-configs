...
3. **`edit-jump.lua`** — handles two paths: diff-accepted edits (`ClaudeCodeDiffClosed`) and automode direct edits (the inotify event above). Jumps to the edited file without stealing focus from an active terminal.
